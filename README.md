<p align="center"><img width=12.5% src="https://github.com/JNSFilipe/clairvoyant/blob/master/media/Logo.png"></p>
...
<p align="center"><img width=95% src="https://github.com/JNSFilipe/clairvoyant/blob/master/media/Schematic.png"></p>

<br>

## Visualize the Learning Process
<img src="https://github.com/JNSFilipe/clairvoyant/blob/master/media/Learning.gif" width=40%>
...
```bash
python -m pip install git+https://github.com/JNSFilipe/clairvoyant
```
...
<img src="https://github.com/JNSFilipe/clairvoyant/blob/master/media/SBUX.png">
...
## Contributing
Please take a look at our [contributing](https://github.com/JNSFilipe/clairvoyant/blob/master/CONTRIBUTING.md) guidelines if you're interested in helping!
#### Pending Features
- Export model
